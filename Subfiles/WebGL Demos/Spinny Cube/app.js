...
var InitDemo = function () {
	...
	[ // X, Y, Z           R, G, B
		...
		1.0, 1.0, 1.0,     0, 1, 0.75,
		1.0, 1.0, -1.0,    1, 0.75, 1,

		// Left
		-1.0, 1.0, 1.0,    1, 1, 0.5,
		-1.0, -1.0, 1.0,   1, 0.25, 0.5,
		-1.0, -1.0, -1.0,  0.75, 1, 0.5,
		-1.0, 1.0, -1.0,   1, 0.25, 1,

		// Right
		1.0, 1.0, 1.0,    1, 0.25, 0.75,
		1.0, -1.0, 1.0,   0.25, 1, 0.75,
		1.0, -1.0, -1.0,  1, 0.25, 0.75,
		1.0, 1.0, -1.0,   0.25, 0.25, 1,
		...
		// Back
		1.0, 1.0, -1.0,    0.0, 1.5, 0.15,
		1.0, -1.0, -1.0,    0.0, 1.0, 1.15,
